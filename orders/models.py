...
class Order(models.Model):
    ...
    shipping_total = models.DecimalField(default=5000, max_digits=8, decimal_places=3) #Valor de envio
    total = models.DecimalField(default=0.0, max_digits=8, decimal_places=3)  #carrito de compras+total envio
